...
import (
	...
	blockchain_transaction_syncs "github.com/Gavine-Gao/blockchain-sync-account"
	"github.com/Gavine-Gao/blockchain-sync-account/common/cliapp"
	"github.com/Gavine-Gao/blockchain-sync-account/common/opio"
	"github.com/Gavine-Gao/blockchain-sync-account/config"
	"github.com/Gavine-Gao/blockchain-sync-account/database"
	flags2 "github.com/Gavine-Gao/blockchain-sync-account/flags"
	"github.com/Gavine-Gao/blockchain-sync-account/notifier"
	...
	"github.com/Gavine-Gao/blockchain-sync-account/services"
)
...
func runBlockchainSync(ctx *cli.Context, shutdown context.CancelCauseFunc) (cliapp.Lifecycle, error) {
	...
	return &cli.App{
		...
		Commands: []*cli.Command{
			...
			},
			{
				...
				Action:      cliapp.LifecycleCmd(runBlockchainSync),
			},
			{
				Name:        "notify",
				Flags:       flags,
