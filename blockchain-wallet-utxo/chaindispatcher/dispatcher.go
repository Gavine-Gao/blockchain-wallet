...
import (
	...
	"github.com/Gavine-Gao/blockchain-wallet-utxo/chain/bitcoin"
	"github.com/Gavine-Gao/blockchain-wallet-utxo/chain/bitcoincash"
	"github.com/Gavine-Gao/blockchain-wallet-utxo/chain/dash"
	"github.com/Gavine-Gao/blockchain-wallet-utxo/chain/dogecoin"
	"github.com/Gavine-Gao/blockchain-wallet-utxo/chain/litecoin"
	"github.com/Gavine-Gao/blockchain-wallet-utxo/chain/zen"
	"github.com/Gavine-Gao/blockchain-wallet-utxo/config"
	"github.com/Gavine-Gao/blockchain-wallet-utxo/rpc/common"
...
func New(conf *config.Config) (*ChainDispatcher, error) {
	...
	chainAdaptorFactoryMap := map[string]func(conf *config.Config) (chain.IChainAdaptor, error){
		...
		strings.ToLower(dogecoin.ChainName):    dogecoin.NewChainAdaptor,
	...
	supportedChains := []string{
		...
		strings.ToLower(dogecoin.ChainName),
