...
const (
	WalletAccountService_GetSupportChains_FullMethodName          = "/blockchain.account.WalletAccountService/getSupportChains"
	WalletAccountService_ConvertAddress_FullMethodName            = "/blockchain.account.WalletAccountService/convertAddress"
	WalletAccountService_ValidAddress_FullMethodName              = "/blockchain.account.WalletAccountService/validAddress"
	WalletAccountService_GetBlockByNumber_FullMethodName          = "/blockchain.account.WalletAccountService/getBlockByNumber"
	WalletAccountService_GetBlockByHash_FullMethodName            = "/blockchain.account.WalletAccountService/getBlockByHash"
	WalletAccountService_GetBlockHeaderByHash_FullMethodName      = "/blockchain.account.WalletAccountService/getBlockHeaderByHash"
	WalletAccountService_GetBlockHeaderByNumber_FullMethodName    = "/blockchain.account.WalletAccountService/getBlockHeaderByNumber"
	WalletAccountService_GetBlockHeaderByRange_FullMethodName     = "/blockchain.account.WalletAccountService/getBlockHeaderByRange"
	WalletAccountService_GetAccount_FullMethodName                = "/blockchain.account.WalletAccountService/getAccount"
	WalletAccountService_GetFee_FullMethodName                    = "/blockchain.account.WalletAccountService/getFee"
	WalletAccountService_SendTx_FullMethodName                    = "/blockchain.account.WalletAccountService/SendTx"
	WalletAccountService_GetTxByAddress_FullMethodName            = "/blockchain.account.WalletAccountService/getTxByAddress"
	WalletAccountService_GetTxByHash_FullMethodName               = "/blockchain.account.WalletAccountService/getTxByHash"
	WalletAccountService_BuildUnSignTransaction_FullMethodName    = "/blockchain.account.WalletAccountService/buildUnSignTransaction"
	WalletAccountService_BuildSignedTransaction_FullMethodName    = "/blockchain.account.WalletAccountService/buildSignedTransaction"
	WalletAccountService_DecodeTransaction_FullMethodName         = "/blockchain.account.WalletAccountService/decodeTransaction"
	WalletAccountService_VerifySignedTransaction_FullMethodName   = "/blockchain.account.WalletAccountService/verifySignedTransaction"
	WalletAccountService_GetExtraData_FullMethodName              = "/blockchain.account.WalletAccountService/getExtraData"
	WalletAccountService_GetNftListByAddress_FullMethodName       = "/blockchain.account.WalletAccountService/getNftListByAddress"
	WalletAccountService_GetNftCollection_FullMethodName          = "/blockchain.account.WalletAccountService/getNftCollection"
	WalletAccountService_GetNftDetail_FullMethodName              = "/blockchain.account.WalletAccountService/getNftDetail"
	WalletAccountService_GetNftHolderList_FullMethodName          = "/blockchain.account.WalletAccountService/getNftHolderList"
	WalletAccountService_GetNftTradeHistory_FullMethodName        = "/blockchain.account.WalletAccountService/getNftTradeHistory"
	WalletAccountService_GetAddressNftTradeHistory_FullMethodName = "/blockchain.account.WalletAccountService/getAddressNftTradeHistory"
)
...
var WalletAccountService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "blockchain.account.WalletAccountService",
	...
	Metadata: "blockchain/account.proto",
}
