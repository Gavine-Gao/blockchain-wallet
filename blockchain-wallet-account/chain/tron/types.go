...
// UnSignTrc20Transaction TRC20 未签名交易
...
// CreateTransactionRequest TRX 转账请求
...
// TriggerSmartContractRequest TRC20 转账请求
...
// BroadcastTransactionRequest 广播交易请求
...
// SignedTransactionData 已签名交易数据（从客户端传入的 base64 编码 JSON）
