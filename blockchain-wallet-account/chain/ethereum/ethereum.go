...
import (
	...
	"github.com/Gavine-Gao/blockchain-wallet-account/chain/evmbase"
	"github.com/Gavine-Gao/blockchain-wallet-account/common/util"
	"github.com/Gavine-Gao/blockchain-wallet-account/config"
	"github.com/Gavine-Gao/blockchain-wallet-account/rpc/account"
	common2 "github.com/Gavine-Gao/blockchain-wallet-account/rpc/common"
)
...
func (c *ChainAdaptor) ConvertAddress(req *account.ConvertAddressRequest) (*account.ConvertAddressResponse, error) {
	...
	pubkBytes, err := hex.DecodeString(pubKey)
	if err != nil {
	...
	//1.去掉未压缩的公钥前缀0x04 剩下64字节（x+y）
	//2.对64字节做Keccak256
	//3.取后20位生成地址
	addressCommon := common.BytesToAddress(crypto.Keccak256(pubkBytes[1:])[12:])
	return &account.ConvertAddressResponse{
		Code:    common2.ReturnCode_SUCCESS,
		Msg:     "support this chain",
